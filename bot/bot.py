...
SPEAKER_TEXT = (
    "🌴 <b>Добро пожаловать в чат Бизнес Клуба Самуи!</b>\n\n"
    "👋 <b>Если ты новенький</b> — представься в чате:\n"
    "• Кто ты и в какой нише твой проект/бизнес?\n"
    "• Чем можешь быть полезен (твоя суперсила)?\n"
    "• Какой у тебя сейчас главный запрос?\n\n"
    "🎤 Хочешь провести полезную встречу или выступить спикером клуба? "
    "Пиши Натали: @Natali_na_Samui"
)
